...
<%-- accepts the decoded URL parameter and sets it in the target field of the button--%>
<form action="/sign-in" method="post">
    ...
    <button type="submit" class="btn btn-primary ${classes }" style="margin-right: 10px"><i class="fa fa-facebook-official" aria-hidden="true"></i> Sign in</button>
</form>
